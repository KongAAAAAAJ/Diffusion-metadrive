...
def _derive_lane_decision_from_mode_idx(mode_idx: int) -> "LaneDecision":
    ...
    from models.diffusion.mode_definitions import get_mode_slot
...
def _build_live_target_lane_polyline(
    ...
    try:
        from models.diffusion.mode_context import _lane_start_longitudinal
...
def _build_mode_features(sample: Dict[str, np.ndarray], config: TransfuserConfig) -> Dict[str, torch.Tensor]:
    ...
    """
    from models.diffusion.mode_context import build_mode_context_from_sample
