...
from models.diffusion.transfuser_backbone import TransfuserBackbone
from models.diffusion.transfuser_features import BoundingBox2DIndex
from diffusers.schedulers import DDIMScheduler
from models.diffusion.modules.conditional_unet1d import ConditionalUnet1D,SinusoidalPosEmb
import torch.nn.functional as F
from models.diffusion.modules.blocks import linear_relu_ln,bias_init_with_prob, gen_sineembed_for_position, GridSampleCrossBEVAttention
...
class V2TransfuserModel(nn.Module):
    ...
    def _encode_target_guidance(self, features: Dict[str, torch.Tensor]) -> Optional[torch.Tensor]:
        ...
        # "point" and "external_point" both condition on a single features["target_point"] [B, 2].
        # For external_point the value is injected by RuleMaker before extract_rl_context().
        target_point: Optional[torch.Tensor] = features.get("target_point")
