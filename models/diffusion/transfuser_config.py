...
class TransfuserConfig:
    ...
    plan_anchor_path: str = "expert_dataset/metadrive_anchors.npy"
    ...
    def __post_init__(self) -> None:
        ...
        if self.target_guidance_type not in ("point", "line", "multi_point", "external_point"):
            raise ValueError(
                f"target_guidance_type must be 'point', 'line', 'multi_point', or 'external_point', "
                f"got {self.target_guidance_type!r}"
            )
        if self.preference:
