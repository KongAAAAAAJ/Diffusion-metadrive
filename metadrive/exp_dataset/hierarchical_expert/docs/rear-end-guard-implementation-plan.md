...
- Create: `metadrive/exp_dataset/hierarchical_expert/rear_end_guard.py`
  Purpose: implement `RearEndGuardRegulator`
- Modify: `metadrive/exp_dataset/hierarchical_expert/hierarchical_policy.py`
...
- Modify: `metadrive/exp_dataset/hierarchical_expert/__init__.py`
  Purpose: export `RearEndGuardRegulator`
- Create: `metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py`
  Purpose: isolated unit tests for guard logic
- Modify: `metadrive/exp_dataset/hierarchical_expert/tests/test_hierarchical_policy.py`
  Purpose: verify policy wiring, ordering, reset behavior, and diagnostics
- Modify: `metadrive/exp_dataset/hierarchical_expert/tests/test_integration.py`
...
**Files:**
- Create: `metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py`
- Reference: `metadrive/exp_dataset/hierarchical_expert/docs/rear-end-guard-design.md`
...
Run:
```bash
/home/kong/anaconda3/envs/meta_drive/bin/python -m pytest metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py -q
```
...
```bash
git add metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py
...
**Files:**
- Create: `metadrive/exp_dataset/hierarchical_expert/rear_end_guard.py`
- Test: `metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py`
...
```bash
git add metadrive/exp_dataset/hierarchical_expert/rear_end_guard.py metadrive/exp_dataset/hierarchical_expert/tests/test_rear_end_guard.py
...
Run:
```bash
/home/kong/anaconda3/envs/meta_drive/bin/python -m pytest metadrive/exp_dataset/hierarchical_expert/tests/test_hierarchical_policy.py -q
```
...
```bash
git add metadrive/exp_dataset/hierarchical_expert/hierarchical_policy.py metadrive/exp_dataset/hierarchical_expert/__init__.py metadrive/exp_dataset/hierarchical_expert/tests/test_hierarchical_policy.py
...
Run:
```bash
/home/kong/anaconda3/envs/meta_drive/bin/python -m pytest metadrive/exp_dataset/hierarchical_expert/tests/test_integration.py -q
```
...
Run:
```bash
/home/kong/anaconda3/envs/meta_drive/bin/python -m pytest metadrive/exp_dataset/hierarchical_expert/tests -q
```
Expected: PASS
...
```bash
git add metadrive/exp_dataset/hierarchical_expert/tests/test_integration.py metadrive/exp_dataset/hierarchical_expert/rear_end_guard.py metadrive/exp_dataset/hierarchical_expert/hierarchical_policy.py
...
```bash
git add metadrive/exp_dataset/hierarchical_expert/rear_end_guard.py
...
- Keep all new logic inside `metadrive/exp_dataset/hierarchical_expert/`
- Do not edit `metadrive/exp_dataset/expert_idm_policy.py`
