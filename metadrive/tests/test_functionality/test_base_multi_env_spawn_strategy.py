...
def _load_base_multi_env_module():
    ...
    route_spawn_module = types.ModuleType("envs.diffusion_envs.route_spawn_manager")
    route_spawn_module.RouteAwareSpawnManager = type("RouteAwareSpawnManager", (), {})
    register("envs.diffusion_envs.route_spawn_manager", route_spawn_module)

    custom_traffic_module = types.ModuleType("envs.diffusion_envs.route_traffic_manager")
    custom_traffic_module.RouteAwareTrafficManager = type("RouteAwareTrafficManager", (), {})
    register("envs.diffusion_envs.route_traffic_manager", custom_traffic_module)
