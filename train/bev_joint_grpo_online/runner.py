...
def run_joint_grpo_training(training_config: JointGRPOTrainingConfig, *, run_dir: Path) -> dict[str, object]:
    ...
    grpo_config = JointGRPOConfig(
        ...
        risk_pact_longitudinal_margin_m=risk.longitudinal_margin_m,
        risk_pact_lateral_margin_m=risk.lateral_margin_m,
        risk_pact_minimum_sigma_x_m=risk.minimum_sigma_x_m,
        risk_pact_minimum_sigma_y_m=risk.minimum_sigma_y_m,
        risk_pact_ego_length_m=risk.ego_length_m,
        risk_pact_ego_width_m=risk.ego_width_m,
        risk_pact_inflate_actor_by_ego_footprint=risk.inflate_actor_by_ego_footprint,
