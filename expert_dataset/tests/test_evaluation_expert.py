...
def _load_module():
    ...
    expert_dataset_pkg = ModuleType("expert_dataset")
    expert_dataset_pkg.__path__ = []
    hierarchical_pkg = ModuleType("expert_dataset.hierarchical_expert")
    hierarchical_pkg.__path__ = []
    sys.modules["metadrive"] = metadrive_pkg
    sys.modules["expert_dataset"] = expert_dataset_pkg
    sys.modules["expert_dataset.hierarchical_expert"] = hierarchical_pkg

    expert_policy_module = ModuleType("expert_dataset.expert_idm_policy")
    ...
    driving_style_module = ModuleType("expert_dataset.hierarchical_expert.driving_style")
    driving_style_module.DrivingStyleProfile = type("DrivingStyleProfile", (), {})
    hierarchical_policy_module = ModuleType("expert_dataset.hierarchical_expert.hierarchical_policy")
    hierarchical_policy_module.HierarchicalExpertIDMPolicy = type("HierarchicalExpertIDMPolicy", (), {})
    sys.modules["expert_dataset.expert_idm_policy"] = expert_policy_module
    sys.modules["expert_dataset.hierarchical_expert.driving_style"] = driving_style_module
    sys.modules["expert_dataset.hierarchical_expert.hierarchical_policy"] = hierarchical_policy_module
