...
### 必须阅读的文件
1. `expert_dataset/hierarchical_expert/docs/intersection.md`
2. `expert_dataset/hierarchical_expert/hierarchical_policy.py`
3. `expert_dataset/expert_idm_policy.py`
4. `expert_dataset/hierarchical_expert/tests/test_hierarchical_policy.py`
5. `expert_dataset/hierarchical_expert/tests/test_integration.py`
...
### 新增模块
创建 `expert_dataset/hierarchical_expert/intersection_regulator.py`，提供：
...
### 文件
- 新建: `expert_dataset/hierarchical_expert/intersection_regulator.py`
- 新建测试: `expert_dataset/hierarchical_expert/tests/test_intersection_regulator.py`
...
### 文件
- 修改: `expert_dataset/hierarchical_expert/hierarchical_policy.py`
- 修改: `expert_dataset/hierarchical_expert/__init__.py`
- 修改测试: `expert_dataset/hierarchical_expert/tests/test_hierarchical_policy.py`
...
### 文件
- 修改: `expert_dataset/hierarchical_expert/tests/test_integration.py`
...
```bash
python -m pytest expert_dataset/hierarchical_expert/tests/test_intersection_regulator.py -q
python -m pytest expert_dataset/hierarchical_expert/tests/test_hierarchical_policy.py -q
python -m pytest expert_dataset/hierarchical_expert/tests/test_integration.py -q
python -m pytest expert_dataset/hierarchical_expert/tests -q
```

### 真实环境诊断命令

```bash
python -m expert_dataset.run_expert --expert-type idm --episodes 10 --render 0 --print-episode-summary 1 --print-run-summary 1
```
