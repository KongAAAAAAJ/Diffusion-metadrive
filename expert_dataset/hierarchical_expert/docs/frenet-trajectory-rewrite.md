...
> Date: 2026-03-27
> 目标文件: `expert_dataset/hierarchical_expert/trajectory_planner.py`
> 关联文件: `expert_dataset/hierarchical_expert/lane_change_manager.py`
...
```bash
python -m expert_dataset.run_expert --expert-type idm --episodes 10 --render 0 --print-run-summary 1
```
