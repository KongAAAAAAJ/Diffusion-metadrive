...
- 新增实现文件：
  - `expert_dataset/hierarchical_expert/rear_end_guard.py`
- 修改接线文件：
  - `expert_dataset/hierarchical_expert/hierarchical_policy.py`
  - `expert_dataset/hierarchical_expert/__init__.py`
- 新增/修改测试文件：
  - `expert_dataset/hierarchical_expert/tests/test_rear_end_guard.py`
  - `expert_dataset/hierarchical_expert/tests/test_hierarchical_policy.py`
  - `expert_dataset/hierarchical_expert/tests/test_integration.py`
...
- `python -m pytest expert_dataset/hierarchical_expert/tests/test_rear_end_guard.py -q` 通过
- `python -m pytest expert_dataset/hierarchical_expert/tests/test_hierarchical_policy.py -q` 通过
- `python -m pytest expert_dataset/hierarchical_expert/tests/test_integration.py -q` 通过
- regulator 单测全绿
